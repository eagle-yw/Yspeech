...
if(EXISTS "${PREBUILT_ONNXRUNTIME_LIB}")
  ...
  set_target_properties(onnxruntime PROPERTIES
    IMPORTED_LOCATION "${PREBUILT_ONNXRUNTIME_LIB}"
    INTERFACE_INCLUDE_DIRECTORIES "${LIB_DIR}/include/onnxruntime"
  )
  
  file(GLOB ONNXRUNTIME_DEP_LIBS "${LIB_DIR}/lib/*.a")
  list(REMOVE_ITEM ONNXRUNTIME_DEP_LIBS "${PREBUILT_ONNXRUNTIME_LIB}")
  ...
  set(ONNXRUNTIME_INCLUDE_DIR "${LIB_DIR}/include/onnxruntime" CACHE INTERNAL "ONNX Runtime include directory")
  set(onnxruntime_SOURCE_DIR "${LIB_DIR}" CACHE INTERNAL "ONNX Runtime source directory")
  
  message(STATUS "Using prebuilt ONNX Runtime from ${LIB_DIR}")
